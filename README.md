...
* **Frontend:** HTML/CSS/JavaScript, **Three.js**, `OrbitControls`
* **Backend:** **Python 3**, `asyncio`, `psutil`, `websockets`, (tuỳ chọn) `GPUtil`
...
<!-- Chèn ảnh chụp màn hình, ảnh GIF hoặc link video demo để tăng tính trực quan -->
![3D topology + sidebar charts](link_anh_giao_dien.png)

## ⚙️ Hướng dẫn cài đặt (Installation)
### 1) Chuẩn bị môi trường Python
Cần Python 3.x và pip.
...
### 2) (Tuỳ chọn) Xác minh GPU metrics
Nếu máy có NVIDIA và muốn lấy load/VRAM/temp:
